...
cotacao_atual = float(input('Informe a cotação atual do Dollar: '))

if opcao == 1:
    dolares = float(input('Informe a quantidade de dolares:'))
    print(f'O valor em reais é R${cotacao_atual * dolares}')

elif opcao == 2:
    reais = float(input('Informe a quantidade de reais:'))
    print(f'O valor em dollar é R${reais/cotacao_atual}')
